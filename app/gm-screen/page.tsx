...
export default function GMScreen() {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",height:"100vh",background:"#0f1117",overflow:"hidden"}}>
      ...
      {/* 4x3 Panel Grid — panels are individually resizable via drag handles */}
      <div style={{flex:1,display:"grid",gridTemplateColumns:"repeat(4,1fr)",gridTemplateRows:"repeat(3,1fr)",gap:2,padding:2,overflow:"hidden",background:"#0a0c14"}}>
        {grid.map((panel,i)=>(
          <div key={i} style={{background:"#13151f",border:"1px solid #1a1d27",borderRadius:4,display:"flex",flexDirection:"column",overflow:"hidden",minHeight:80,minWidth:120,resize:"both"}}>
            {panel===null?(
              /* Empty slot */
